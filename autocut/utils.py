...
def trans_srt_to_md(encoding, force, srt_fn, video_fn=None):
    ...
    md.write()
# autocut --transcribe video/B_HeiTianEr.mp4      # 转录生成字幕（生成 input.srt 和 input.md）
# autocut --cut video/input.mp4 input.srt   # 根据字幕切割视频（生成 input_cut.mp4）